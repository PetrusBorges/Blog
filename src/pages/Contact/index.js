        ...
        <section className="container">
          <div className="row">
            ...
            <div className="grid-5">
              ...
              <p>contatopetrusborges@gmail.com</p>

              <h6 className="color-primary mt-4">Redes sociais</h6>
              <div className="mt-2">
                <img src={IconFacebook} className="icon-s" alt="LogoFacebook" />
                <img src={IconInstagram} className="icon-s ml-2" alt="LogoInstagram" />
                <img src={IconYoutube} className="icon-s ml-2" alt="LogoYoutube" />
                <img src={IconTwitter} className="icon-s ml-2" alt="LogoTwitter" />
              </div>
            </div>
          </div>
      </section>
