...
//Imagens
import ProfileImg from '../../images/profile/ny.jpg'
        ...
        <div className="row">
            <div className="grid-6">
                <div className="flex-start-row">
                    ...
                    <div className="ml-2">
                        <h3 className="color-white">Petrus Borges</h3>
            ...
            <div className="grid-6 flex-center">
                <a href="#Link" className="btn">Adicionar post</a>
                <a href="#Link" className="btn ml-4">Meus dados</a>
            </div>
        </div>
    </section>
